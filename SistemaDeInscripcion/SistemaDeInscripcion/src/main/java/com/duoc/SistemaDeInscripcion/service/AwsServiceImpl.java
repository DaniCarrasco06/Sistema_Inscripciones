...
import java.nio.charset.StandardCharsets; // CAMBIO: reemplaza StringUtils.UTF8 de SDK v1
    ...
    private static String getAsString(InputStream is) throws IOException {
        ...
        try {
            BufferedReader reader = new BufferedReader(
                new InputStreamReader(is, StandardCharsets.UTF_8)); // Se cambia StringUtils.UTF8 a StandardCharsets.UTF_8
            String line;
